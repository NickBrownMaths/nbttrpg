...
function InteractionGrid(props) {
  ...
  return (
    <div className="GridBase">
      ...
      <InteractionGridBox isAxis={1} number={props.statblock.STAT.cha} label={'wpr'} />
      ...
      <InteractionGridBox isAxis={0} number={getStatInteraction(props.statblock.STAT.wpr, props.statblock.TRNG.fighting) } label={''} />
      ...
      <InteractionGridBox isAxis={0} number={getStatInteraction(props.statblock.STAT.wpr, props.statblock.TRNG.crafting) } label={''} />
      ...
      <InteractionGridBox isAxis={0} number={getStatInteraction(props.statblock.STAT.wpr, props.statblock.TRNG.performing) } label={''} />
      ...
      <InteractionGridBox isAxis={0} number={getStatInteraction(props.statblock.STAT.wpr, props.statblock.TRNG.scholarship) } label={''} />
      ...
      <InteractionGridBox isAxis={0} number={getStatInteraction(props.statblock.STAT.per, props.statblock.TRNG.athletics) } label={'tavern games'} />
      <InteractionGridBox isAxis={0} number={getStatInteraction(props.statblock.STAT.int, props.statblock.TRNG.athletics) } label={'table games'} />
      ...
      <InteractionGridBox isAxis={0} number={getStatInteraction(props.statblock.STAT.wpr, props.statblock.TRNG.athletics) } label={''} />
      ...
      <InteractionGridBox isAxis={0} number={getStatInteraction(props.statblock.STAT.wpr, props.statblock.TRNG.nature) } label={''} />
      ...
      <InteractionGridBox isAxis={0} number={getStatInteraction(props.statblock.STAT.wpr, props.statblock.TRNG.healing) } label={''} />
      ...
      <InteractionGridBox isAxis={0} number={getStatInteraction(props.statblock.STAT.wpr, props.statblock.TRNG.subterfuge) } label={''} />
      ...
      <InteractionGridBox isAxis={0} number={getStatInteraction(props.statblock.STAT.wpr, props.statblock.TRNG.diplomacy) } label={''} />
    </div>
  )
}
